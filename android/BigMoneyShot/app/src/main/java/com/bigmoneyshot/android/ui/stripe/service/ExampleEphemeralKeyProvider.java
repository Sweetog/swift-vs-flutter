...
import com.bigmoneyshot.android.ui.stripe.module.RetrofitFactory;
    ...
    public void createEphemeralKey(@NonNull @Size(min = 4) String apiVersion,
        ...
        mCompositeSubscription.add(
                mStripeService.createEphemeralKey(apiParamMap)
                        ...
                        .subscribe(new Action1<com.squareup.okhttp.ResponseBody>() {
                            @Override
                            public void call(com.squareup.okhttp.ResponseBody response) {
                                try {
