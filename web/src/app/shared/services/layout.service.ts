...
export interface ILayoutConf {
  ...
  matTheme?: string               // material theme. egret-blue, egret-navy, egret-dark-purple, egret-dark-pink, bms-dark
...
export class LayoutService {
  ...
  setAppLayout() {
    ...
    this.layoutConf = {
      ...
      "matTheme": "bms-dark",     // egret-blue, egret-navy, egret-dark-purple, egret-dark-pink, bms-dark
